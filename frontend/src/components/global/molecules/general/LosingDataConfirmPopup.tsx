...
interface LosingDataConfirmPopupProps {
  cancel: () => void;
  continue: () => void;
}

const LosingDataConfirmPopup: React.FC<LosingDataConfirmPopupProps> = (props) => {
      ...
      <div className="flex flex-col justify-center items-center w-auto">
        ...
        <div className="flex items-center mt-2">
          ...
          <span className="text-[11px] text-black">
            By Clicking Continue your data will be Lost
          </span>
        </div>
      </div>
    </Popup>
...
export default LosingDataConfirmPopup;

      ...
      <main>
        <Suspense fallback={<Loading />}>
          <div className="h-screen">
            ...
            <div className="flex">
              <Sidebar
                className={`hide-scrollbar shadow-lg border-r w-[25%] overflow-y-auto overflow-x-hidden z-10 transition-all duration-200 ${!isExpanded ? "w-[0px]" : "max-tmp:absolute max-tmp:bg-white max-tmp:w-[40%] max-md:w-[50%] max-sm:w-[66%] max-xs:w-full"}`}
              />
              <section

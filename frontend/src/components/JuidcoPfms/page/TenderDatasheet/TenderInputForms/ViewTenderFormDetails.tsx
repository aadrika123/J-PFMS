        ...
        <Toaster />
          ...
          <div className="flex flex-col bg-white shadow-xl rounded border p-4">
            ...
            <div className="grid grid-cols-2 gap-2 items-start mt-4">
              <span className="font-medium">
                ...
                <span className="text-gray-500 text-xs">
                  {work_details?.pre_qualification_details}
                </span>
              </span>
              <span className="font-medium">
                Location(Work/Item/Service):&nbsp;
                <span className="text-gray-500 text-xs">
                  {work_details?.location}
                </span>
              </span>
              <span className="font-medium">
                Product Category :&nbsp;
              ...
              <span className="font-medium">
                ...
                <span className="text-gray-500 text-xs">
                  {work_details?.product_sub_category}
                </span>
              </span>
              <span className="font-medium">
          ...
          <div className="bg-white shadow-xl rounded border p-4 grid grid-cols-2 gap-2 items-start mt-4">
            <div className="flex flex-col gap-1">
              <span className="font-medium">
                Pre Bid Meeting:&nbsp;
                <span className="text-gray-500 text-xs">
                  {work_details?.pre_bid_meeting}
                </span>
              </span>
              <span className="font-medium">
                Pre Bid Meeting Place :&nbsp;
                <span className="text-gray-500 text-xs">
                  {work_details?.pre_bid_meeting_place}
                </span>
              </span>
              <span className="font-medium">
                Pre Bid Meeting Address:&nbsp;
                <span className="text-gray-500 text-xs">
                  {work_details?.pre_bid_meeting_address}
                </span>
              </span>
              <span className="font-medium">
                Bid Opening Place :&nbsp;
                <span className="text-gray-500 text-xs">
                  {work_details?.bid_opening_place}
                </span>
              </span>
              <span className="font-medium">
                Tenderer Class :&nbsp;
          ...
          <div className="bg-white shadow-xl rounded border p-4 grid grid-cols-3">
            <span className="font-medium">
              Tender Fee :&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.tender_fee}
              </span>
            </span>
            <span className="font-medium">
              Tender Fee Payable At:&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.tender_fee_payable_at}
              </span>
            </span>
            <span className="font-medium">
              Surg Charges:&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.surcharges}
              </span>
            </span>
            <span className="font-medium">
              Processing Fee:&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.processing_fee}
              </span>
            </span>
            <span className="font-medium">
              Tender Fee Payable To:&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.tender_fee_payable_to}
              </span>
            </span>
            <span className="font-medium">
              Other Charges:&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.other_charges}
              </span>
            </span>
          </div>
          ...
          <div className="bg-white shadow-xl rounded border p-4 grid grid-cols-3">
            <span className="font-medium">
              EMD Fee :&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.emd_fee_type}
              </span>
            </span>
            <span className="font-medium">
              EMD Fee Payable To :&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.emd_fee_payable_to}
              </span>
            </span>
            <span className="font-medium">
            ...
            <span className="font-medium">
              EMD Fee Payable At :&nbsp;
              <span className="text-gray-500 text-xs">
                {fee_details?.emd_fee_payable_at}
              </span>
            </span>
          </div>

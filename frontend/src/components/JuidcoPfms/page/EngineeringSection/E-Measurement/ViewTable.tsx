...
export default function ViewTable() {
  ...
  const [projectNumber, set_projectNumber] = useState(false);
  const [projectStatus, set_projectStatus] = useState(false);

  //const [anchorAl, setAnchorAl] = useState<HTMLElement | null>(null);

  const handleFilterClick = () => {
    set_filterOpen(!filterOpen);
  };
  ...
  /*-
  <div className="flex m-4 bg-red-500 w-full  flex-row justify-between">
                <div className="flex flex-1 font-bold text-md ">Filters</div>
                <button className="flex  flex-1" onClick={onclose}>
                  <CloseButton />
                </button>
              </div>
              <div className="flex flex-1 flex-col">
                <div className="flex ">sda</div>
                <div className="flex ">sadas</div>
              </div>
      ...
      <div className="flex flex-1 flex-row">
        {filterOpen && (
          <div className="flex w-[30%] justify-center items-start">
            <div className="flex flex-1 flex-col m-4 mt-16 h-[80%] justify-start items-start shadow-md rounded-md bg-white">
              <div className="flex w-full justify-between">
                <div className="flex ml-4 mt-4 ">Filters</div>
              ...
              <div className="flex flex-col w-full mt-4">
                ...
                >
                  ...
                  <AccordionDetails>
                    <div className="flex flex-1 mt-2 mb-4">
                      <input type="text" placeholder="Type here.. " />
                    </div>

                    <div>
                      <input id="project1" type="checkbox" />
                      <label className="ml-4" htmlFor="project1">
                        project 1
                      </label>
                    </div>

                    <div>
                      <input id="project2" type="checkbox" />
                      <label className="ml-4" htmlFor="project2">
                        project 2
                      </label>
                    </div>

                    <div>
                      <input id="project3" type="checkbox" />
                      <label className="ml-4" htmlFor="project3">
                        project 3
                      </label>
                    </div>

                    <div>
                      <input id="project4" type="checkbox" />
                      <label className="ml-4" htmlFor="project4">
                        project 4
                      </label>
                    </div>

                    <div>
                      <input id="project5" type="checkbox" />
                      <label className="ml-4" htmlFor="project5">
                        project 5
                      </label>
                    </div>
                  </AccordionDetails>
                ...
                <Accordion
                  sx={{ width: "100%" }}
                  expanded={projectNumber}
                  onChange={() => set_projectNumber(!projectNumber)}
                >
                  <AccordionSummary expandIcon={<ExpandMore />}>
                    <Typography>Project Number</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                    <div className="flex flex-1 mt-2 mb-4">
                      <input type="text" placeholder="Type here.. " />
                ...
                <Accordion
                  ...
                  onChange={() => set_projectStatus(!projectStatus)}
                >
                  <AccordionSummary expandIcon={<ExpandMore />}>
                  ...
                  >
                    <g filter="url(#filter0_d_1541_82)">
                      <rect
                        ...
                        height="45"
                        rx="8.5"
                        transform="rotate(-0.71425 5.22165 1.83781)"
                        fill="white"
                        stroke="#A19BE4"
                      />
                      <g clipPath="url(#clip0_1541_82)">
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M25.2075 17.8399C23.2659 16.0459 24.5709 12.8029 27.214 12.8538L38.2129 13.0658C40.856 13.1167 42.0352 16.4076 40.0258 18.1255L35.7405 21.7892C35.5325 21.9671 35.4104 22.2255 35.4052 22.4991L35.217 32.2605C35.1841 33.9678 33.1035 34.783 31.9196 33.5525L30.0402 31.5993C29.6878 31.233 29.4952 30.7416 29.505 30.2334L29.6562 22.3884C29.6615 22.1147 29.5495 21.8518 29.3484 21.666L25.2075 17.8399ZM27.1771 14.7702C26.2961 14.7532 25.8611 15.8342 26.5083 16.4322L30.6492 20.2583C31.2524 20.8156 31.5884 21.6042 31.5725 22.4253L31.4214 30.2704L33.3007 32.2236L33.4889 22.4622C33.5047 21.6412 33.8708 20.8661 34.495 20.3324L38.7803 16.6687C39.45 16.096 39.057 14.9991 38.176 14.9821L27.1771 14.7702Z"
                          fill="#8F9399"
                        />
                      </g>
                    </g>
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          ...
                          result="effect1_dropShadow_1541_82"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_1541_82"
                          result="shape"
                        />
                      </filter>
                      <clipPath id="clip0_1541_82">
                        <rect
                          ...
                          height="23"
                          fill="white"
                          transform="translate(21.2335 11.7803) rotate(1.10404)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
                ...
                <TableBody>
                  {tableData.map((row, index) => (
                    <TableRow key={row.id}>
                      ...
                      <TableCell className={`${row.status == 'Completed'?'text-green-600':'text-red-400'}`}>
                        {row.status}
                      </TableCell>
                      <TableCell>
                        <div
                          className="p-2 rounded-md bg-indigo-500 text-white text-center w-[4rem] h-[28] cursor-pointer"

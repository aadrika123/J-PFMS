...
const ConfirmationPopup1: React.FC<ConfirmationPopupProps> = (props) => {
    ...
    <Popup title="" zindex={50}>
      <div className="flex flex-col justify-center items-center w-auto">
        ...
        <span className="text-[20px] text-black my-8">
          Warning! Proposal will be Rejected
        </span>
        <div className="centered-container">
          <input
            type="text"
            placeholder="Please write Some Reason "
            className="p-2 border border-indigo-700 rounded-md w-full"
          />
        </div>
        <br />
        <div className="flex items-center">
          <Button className="mr-2" variant="cancel" onClick={handleViewStepper}>
            Cancel
          </Button>

...
const foreign_wrapper = async () => {
  ///////////////// Receipt Types ////////////////////////
    ...
    await prisma.$queryRaw`IMPORT FOREIGN SCHEMA public LIMIT TO (users, wf_roles, wf_roleusermaps, ulb_masters, ulb_ward_masters, ulb_new_wardmaps) FROM SERVER master_fdw INTO public`
